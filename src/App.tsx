    ...
    <Router>
      ...
      <Layout>
        <Routes>
          ...
          <Route path="/services/editing" element={<ServicePage serviceName="Editing" />} />
          <Route path="/services/fiction-writing" element={<ServicePage serviceName="Fiction Writing" />} />
          <Route path="/services/marketing" element={<ServicePage serviceName="Marketing" />} />
          <Route path="/services/non-fiction-writing" element={<ServicePage serviceName="Non Fiction Writing" />} />
          <Route path="/services/publishing" element={<ServicePage serviceName="Publishing" />} />
